...
var MapsLib = {
  ...
  fusionTableId:      "1LrG86MIe2aYfa1Z4ZWd5R-9HM1S6_nkzLjPw07Lf", //Point data layer
  
  polygon1TableID:    "1L3-Uufk2U_Z95M_WxYB21_JWV-QUubm_nmbLESXm", //Outline map layer of CT town boundaries
  polygon2TableID:    "1LrG86MIe2aYfa1Z4ZWd5R-9HM1S6_nkzLjPw07Lf", //Thematic map layer of selected CT school districts

  //*MODIFY Fusion Tables Requirement* API key. found at https://code.google.com/apis/console/
  //*Important* this key is for demonstration purposes. please register your own.
  googleApiKey:       "AIzaSyAQVkNSgnvp4Ms9EjJCRkngIleA4mlqx0A",
  ...
  map_centroid:       new google.maps.LatLng(40.3,-104.7), //center that your map defaults to
  ...
  initialize: function() {
    ...
    var myOptions = {
      ...
      styles: [
        {
          stylers: [
            { saturation: -30 }, // MODIFY Saturation and Lightness if needed
            { lightness: 25 }     // Current values make thematic polygon shading stand out over base map
          ]
        }
      ]
    };
    ...
    $("#rbPolygon2").attr("checked", "checked"); 
 ...
 //   whereClause += " AND " + type_column + " IN ('" + tempWhereClause.join("','") + "')";
  ...
  submitSearch: function(whereClause, map, location) {
    ...
    //for more details, see https://developers.google.com/fusiontables/docs//using#WorkingStyles
  ...
  query: function(selectColumns, whereClause, groupBY, orderBY, limit, callback) {
    ...
    // console.log(sql)
    $.ajax({url: "https://www.googleapis.com/fusiontables/v2/query?sql="+sql+"&callback="+callback+"&key=AIzaSyAQVkNSgnvp4Ms9EjJCRkngIleA4mlqx0A", dataType: "jsonp"});
  },
